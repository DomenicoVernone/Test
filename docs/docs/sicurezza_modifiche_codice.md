# Modifiche al Codice — Sicurezza API Clinical Twin
**Progetto:** Tesi-FTD — MLOps Clinical Twin  
**Standard:** OWASP API Security Top 10 (2023)  
**Totale modifiche:** 30 (Gruppi 1–6)
...
### Perché funziona
`127.0.0.1:PORT:8000` istruisce Docker a bindare la porta dell'host solo sull'interfaccia di loopback. Qualsiasi richiesta da IP esterno (incluse interfacce eth0, wlan0) viene ignorata a livello kernel — nessun pacchetto raggiunge il container. I microservizi interni comunicano tra loro tramite la rete Docker interna (`clinical_twin_net`) senza bisogno di passare per l'host.
...
*Documento estratto da SECURITY_COMPLETE_REPORT.md — 2026-06-23*  
