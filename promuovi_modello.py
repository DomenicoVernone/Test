...
# --- 1. CONFIGURAZIONE DAGSHUB (COMPILA QUESTI 4 CAMPI CON ATTENZIONE) ---
DAGSHUB_USER = "carlosto033"        # Es: carlo...
DAGSHUB_TOKEN = "c51e647b17ed4364332eaba8a4822ae34511fcee"          # Il token (lo stesso che hai nel file .env del backend)
REPO_OWNER = "donatooooooo"     # Di solito sei tu (IL_TUO_USERNAME), o Pracella se l'ha creata lui
REPO_NAME = "FTD_diagnosis"        # Es: PROGETTO_TESI o come si chiama su DagsHub
...
run_id = "9fd7a844f99042fc87bbd13a2cc86bd1" 
...
try:
    ...
    if "RESOURCE_ALREADY_EXISTS" in str(e):
        ...
        exit(1) # Ferma lo script prima di fare altri danni!
